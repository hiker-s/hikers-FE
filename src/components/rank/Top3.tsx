...
const Top3 = () => {
  const dummyRank = {
    myRank: { id: 23, rank: 23, name: "하이커스", stamp: 11, status: "same" },
    ranker: [
      { id: 1, rank: 1, name: "하이하이", stamp: 10, status: "same" },
      { id: 2, rank: 2, name: "안녕", stamp: 42, status: "down" },
      { id: 3, rank: 3, name: "하이커", stamp: 38, status: "same" },
      { id: 4, rank: 4, name: "이커스", stamp: 35, status: "up" },
      { id: 5, rank: 5, name: "하아이", stamp: 32, status: "down" },
      { id: 6, rank: 6, name: "커어스", stamp: 31, status: "up" },
      { id: 7, rank: 7, name: "커어스", stamp: 31, status: "up" },
      { id: 8, rank: 8, name: "커어스", stamp: 31, status: "up" },
      { id: 9, rank: 9, name: "커어스", stamp: 31, status: "same" },
      { id: 10, rank: 10, name: "커어스", stamp: 31, status: "down" },
    ],
  };
